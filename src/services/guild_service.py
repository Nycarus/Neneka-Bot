...
class GuildService:
    ...
    async def addGuild(self, id: int, notificationChannelID: int=None, roleID:int=None):
    ...
    async def updateGuild (self, id: int, notificationChannelID:int = None, roleID:int = None):
        result = await self._guildRepository.findByID(id)
